...
def disk_proxy_direct(method, cache_file, dependencies=None):
    """
...
def try_cache(filename, method_args=None, method_params=None, dependencies=None):
    """
...
def store_cache_object(obj, filename, method_args=None, method_params=None):
    """
